...
# дохода с учетом премии (get_total_income). П
# роверить работу примера на реальных данных (создать экземпляры класса
...
class Position(Worker):
    ...
    def get_full_name(self):
        return self.name + " " + self.surname + "Работает на должности:" + " " + self.position

    def get_total_income(self):
        return self._income.get('wage') + self._income.get('bonus')


petr = Position("Petr", "Petrov", "Офисный Планктон", 4, 6)
print(petr.get_full_name())
print(petr.get_total_income())
